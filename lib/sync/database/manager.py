...
class DatabaseManager:
    ...
    def __init__(self, db_path: str):
        ...
        self._optionset_manager: Optional[OptionSetManager] = None

    @property
    def optionset_manager(self) -> OptionSetManager:
        """Lazy initialization of OptionSetManager."""
        if self._optionset_manager is None:
            self._optionset_manager = OptionSetManager(self)
        return self._optionset_manager
    ...
    def upsert_batch(
        ...
        for api_record in api_records:
            ...
            if detected_option_sets:
                self.optionset_manager.populate_detected_option_sets(
