"""Option set and junction table operations for sync database."""
...
class OptionSetManager:
    """Manages option set lookup tables and junction tables."""

    def __init__(self, db: "DatabaseManager"):
        """
        Initialize with a DatabaseManager reference.

        Args:
            db: DatabaseManager instance for connection and helpers
        """
        self.db = db
    ...
    def ensure_junction_table(self, entity_name: str, field_name: str, entity_pk: str) -> None:
        ...
        self.db.create_index(table_name, "entity_id")
        ...
        self.db.create_index(table_name, "valid_to")
